...
private void initComponents() {
	...
	String [] cityList = {"Select City..", "Moscow", "New York", "Bombay","Toronto"};
	
	cityDetails.put("Select City..", "0:37.0");
	cityDetails.put("Moscow", "55.7522222:37.6155556");
	cityDetails.put("New York", "40.7141667:-74.0063889");
	cityDetails.put("Bombay", "18.975:72.825833");
	cityDetails.put("Toronto", "43.666667:-79.416667");
  ...
  //======== dialogPane ========
  {
   ...
   panel1.add(cityCombo, new TableLayoutConstraints(2, 0, 2, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

   //---- ttfLat ----
  // ttfLat.setText("38.931099");
   panel1.add(cityCombo, new TableLayoutConstraints(3, 0, 3, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
